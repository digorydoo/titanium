...
class MutableSunDirection private constructor(
    override val vector: MutableVector3f,
    override var phi: Float,
    override var rho: Float,
): SunDirection(vector, phi, rho) {
    constructor(): this(MutableVector3f(), 0.0f, 0.0f)
    constructor(other: SunDirection): this(MutableVector3f(other.vector), other.phi, other.rho)
