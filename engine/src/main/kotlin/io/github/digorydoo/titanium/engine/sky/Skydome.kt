...
class Skydome {
    ...
    companion object {
        ...
        private val cubePts = arrayOf(
            Vector3f(-1.0f, -1.0f, -1.0f), // 0
            Vector3f(1.0f, -1.0f, -1.0f), // 1
            Vector3f(1.0f, 1.0f, -1.0f), // 2
            Vector3f(-1.0f, 1.0f, -1.0f), // 3
            Vector3f(-1.0f, -1.0f, Z4), // 4
            Vector3f(1.0f, -1.0f, Z4), // 5
            Vector3f(1.0f, 1.0f, Z4), // 6
            Vector3f(-1.0f, 1.0f, Z4), // 7
            Vector3f(-X9, -1.0f, 1.0f), // 8
            Vector3f(X9, -1.0f, 1.0f), // 9
            Vector3f(1.0f, -X9, 1.0f), // 10
            Vector3f(1.0f, X9, 1.0f), // 11
            Vector3f(X9, 1.0f, 1.0f), // 12
            Vector3f(-X9, 1.0f, 1.0f), // 13
            Vector3f(-1.0f, X9, 1.0f), // 14
            Vector3f(-1.0f, -X9, 1.0f), // 15
            Vector3f(0.0f, -1.0f, Z4), // 16
            Vector3f(1.0f, 0.0f, Z4), // 17
            Vector3f(0.0f, 1.0f, Z4), // 18
            Vector3f(-1.0f, 0.0f, Z4), // 19
            Vector3f(0.0f, 0.0f, 1.0f), // 20
        )
    }
}
