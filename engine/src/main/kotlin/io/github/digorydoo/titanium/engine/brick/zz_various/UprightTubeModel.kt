...
class UprightTubeModel(private val numSides: Int, private val radius: Float): AbstrBrickModel() {
    private val upperMid = MutableVector3f()
    private val lowerMid = MutableVector3f()
    private val upperCirc = Array(numSides) { MutableVector3f() }
    private val lowerCirc = Array(numSides) { MutableVector3f() }
    private val texMid = Vector2f(0.5f, 0.5f)
    private val texCirc = Array(numSides) { MutableVector2f() }
