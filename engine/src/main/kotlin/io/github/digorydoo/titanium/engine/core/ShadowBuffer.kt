...
import io.github.digorydoo.titanium.engine.camera.Projection
...
abstract class ShadowBuffer {
    ...
    private class CameraSettings {
        ...
        var phi = 0.0f
        var rho = 0.0f
        val dir = MutableVector3f()
        val sourcePos = MutableVector3f()
    ...
    private val shadowCentre = MutableVector3f()
