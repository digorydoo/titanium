...
class WallCornerNWModel(private val relInset: Float, private val ceiling: Boolean): AbstrBrickModel() {
    private val upperNEPt = MutableVector3f()
    private val upperSWPt = MutableVector3f()
    private val ceilSouthMidPt = MutableVector3f()
    private val ceilEastMidPt = MutableVector3f()
    private val ceilWestOuterPt = MutableVector3f()
    private val ceilCentrePt = MutableVector3f()
    private val ceilSEOuterPt = MutableVector3f()
    private val lowerSouthMidPt = MutableVector3f()
    private val lowerEastMidPt = MutableVector3f()
    private val lowerWestOuterPt = MutableVector3f()
