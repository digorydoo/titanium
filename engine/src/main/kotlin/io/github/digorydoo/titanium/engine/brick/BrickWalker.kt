...
class BrickWalker(private val volume: BrickVolume) {
    ...
    fun forEachBrickOnWorldLine(
        ...
        val brickOrigin = MutableVector3f(
        ...
        val worldPtInsideBrick = MutableVector3f(brickOrigin).add(
        ...
        val intersection = MutableVector3f()
    ...
    private fun findFarBrickSideOnRay(
        rayOrigin: Vector3f,
        rayDir: Vector3f,
        brickOrigin: Vector3f,
        maxRayLength: Float,
        intersection: MutableVector3f,
    ): Boolean {
        val v0 = MutableVector3f()
        val v1 = MutableVector3f()
        val v2 = MutableVector3f()
