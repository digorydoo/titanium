package io.github.digorydoo.titanium.engine.ui
...
import io.github.digorydoo.titanium.engine.font.FontManager.FontName.SNACKBAR_FONT
...
class SnackbarGel private constructor(val textTex: Texture, val bgTex: Texture): GraphicElement() {
    ...
    override fun onAnimateActive() {
        moveTo(
            screenSizeDp.x.toFloat() / 2 - bgTex.width / 2,
    ...
    private fun makeRenderer(): Renderer {
        ...
        val textPos = MutableVector3f() // cached to avoid creating new object all the time
