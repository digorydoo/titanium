...
import io.github.digorydoo.titanium.engine.mesh.SimpleMesh
...
class HeightMap(
    ...
    fun getWorldCoords(x: Int, y: Int, centre: Vector3f, rotationPhi: Float, worldCoords: MutableVector3f) {
    ...
    private fun triangulateFlat(positions: FloatBuffer, normals: FloatBuffer) {
        val p0 = MutableVector3f()
        val p1 = MutableVector3f()
        val p2 = MutableVector3f()
        val p3 = MutableVector3f()

        val n = MutableVector3f()
    ...
    fun triangulateSmooth(positions: FloatBuffer, normals: FloatBuffer) {
        ...
        val normalsArr = Array(numSamplesX) { Array(numSamplesY) { MutableVector3f() } }
