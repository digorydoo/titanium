...
import io.github.digorydoo.titanium.engine.brick.BrickMaterial.GREY_CONCRETE
import io.github.digorydoo.titanium.engine.brick.BrickShape
import io.github.digorydoo.titanium.engine.brick.BrickShape.NONE
...
internal class DrawingWizard {
    ...
    fun getSuggestions(brickPos: Vector3i): List<BrickShapeAndMaterial> {
        val x = brickPos.x
        val y = brickPos.y
        val z = brickPos.z
