...
class BevelEEModel: AbstrBrickModel() {
    private val innerUpper3 = MutableVector3f()
    private val innerUpper1 = MutableVector3f()
    private val inner20Upper2 = MutableVector3f()
    private val inner20Upper0 = MutableVector3f()
    ...
    private val outer31Mid3 = MutableVector3f()
    private val outer31Mid1 = MutableVector3f()
    private val outer20Mid2 = MutableVector3f()
    private val outer20Mid0 = MutableVector3f()
    private val outer23Mid3 = MutableVector3f()
    private val outer01Mid1 = MutableVector3f()
