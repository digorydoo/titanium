...
class CameraProps {
    ...
    val sourcePos = SmoothVector3f(accel = 1.5f, normalBrake = 0.25f, strongBrake = 0.30f)
    val targetPos = SmoothVector3f(accel = 0.8f, normalBrake = 0.20f, strongBrake = 0.25f)
    val phi = SmoothAngle(DEFAULT_PHI, accel = 2.9f, normalBrake = 0.25f, strongBrake = 0.30f)
    val rho = SmoothAngle(DEFAULT_RHO, accel = 2.9f, normalBrake = 0.25f, strongBrake = 0.30f)
