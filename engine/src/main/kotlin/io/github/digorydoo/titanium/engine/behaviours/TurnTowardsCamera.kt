...
class TurnTowardsCamera(
    ...
    abstract class Delegate {
        ...
        open val centre: Vector3f? = null // set this to the gel's pos when keepBehind > 0 or usePosition is true
        val renderPos = MutableVector3f() // will be updated when keepBehind > 0
    }

    private val matPhi = MutableMatrix4f { 0.0f }
    private val matRho = MutableMatrix4f { 0.0f }
    private val tmpPt1 = MutableVector4f()
    private val tmpPt2 = MutableVector4f()
