...
import ch.digorydoo.titanium.engine.physics.helper.CuboidCheckResults
import ch.digorydoo.titanium.engine.physics.helper.CuboidHit
...
internal class CollideCylinderVsCuboid: CollisionStrategy<FixedCylinderBody, FixedCuboidBody>() {
    ...
    override fun computeNextSpeed(body1: FixedCylinderBody, body2: FixedCuboidBody, hit: HitResult) {
        when (hit.area2) {
            HitArea.TOP -> {
                val normDir12Z = -1.0f // points from body1 to body2
