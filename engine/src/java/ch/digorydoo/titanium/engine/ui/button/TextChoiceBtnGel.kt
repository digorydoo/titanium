...
class TextChoiceBtnGel(
    private val choice: TextChoice,
    ...
    override fun toString() = "TextChoiceBtnGel($choice)"

    companion object {
        private fun makeCombinedRenderer(gel: TextChoiceBtnGel): Renderer {
