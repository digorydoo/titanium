...
class IntChoiceBtnGel(
    private val choice: IntChoice,
    ...
    private val valueTex = makeStringValueTexture(choice.curValue.toString())
    ...
    private fun valueChanged() {
        redrawStringValue(valueTex, choice.curValue.toString())
    ...
    override fun toString() = "IntChoiceBtnGel($choice)"

    companion object {
        private val TAG = Log.Tag("IntChoiceBtnGel")

        private fun makeCombinedRenderer(gel: IntChoiceBtnGel): Renderer {
        ...
        private fun makeValueRenderer(gel: IntChoiceBtnGel): Renderer {
        ...
        private fun makeIncDecRenderer(gel: IntChoiceBtnGel, isInc: Boolean): Renderer {
            val bgTex = gel.bgTex
            val incDecFrames = gel.incDecFrames
