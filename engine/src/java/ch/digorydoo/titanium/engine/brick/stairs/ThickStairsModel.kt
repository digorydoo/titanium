...
import ch.digorydoo.titanium.engine.brick.THICK_RELSIZE
...
class ThickStairsModel(
    ...
    private val lowerBackPt2 = MutablePoint3f()
    private val lowerBackPt3 = MutablePoint3f()
    private val upperBackPt2 = MutablePoint3f()
    private val upperBackPt3 = MutablePoint3f()
