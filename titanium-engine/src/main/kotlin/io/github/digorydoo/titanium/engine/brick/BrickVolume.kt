...
class BrickVolume(
    ...
    private val tempRelCoords = MutableVector3i()

    private fun subAt(
        brickX: Int,
        brickY: Int,
        brickZ: Int,
        outSubRelativeCoords: MutableVector3i? = null,
    ): BrickSubvolume? {
    ...
    fun isWorldPtInBounds(worldPt: Vector3f): Boolean {
    ...
    fun clampToSize(brickPos: MutableVector3i) {
    ...
    fun getAtBrickCoord(
        brickCoord: Vector3i,
        brick: Brick,
        outWorldCoords: MutableVector3f? = null,
        outSubRelativeCoords: MutableVector3i? = null,
    ) {
    ...
    fun getAtWorldCoord(worldPt: Vector3f, brick: Brick, outBrickCoords: MutableVector3i? = null) {
    ...
    fun getAtWorldCoord(
        ...
        worldZ: Float,
        brick: Brick,
        outBrickCoords: MutableVector3i? = null,
    ) {
    ...
    fun forEachBrickOnWorldLine(
        worldStartPt: Vector3f,
        worldEndPt: Vector3f,
        lambda: (brick: Brick, worldPtOfBrickEntry: Vector3f, rayVector: Vector3f) -> Boolean,
    ...
    companion object {
        ...
        fun brickToWorld(brickX: Int, brickY: Int, brickZ: Int, result: MutableVector3f) {
            result.set(
        ...
        fun worldToBrick(worldPt: Vector3f, brickPos: MutableVector3i) {
            brickPos.set(
