...
class BevelWWModel: AbstrBrickModel() {
    ...
    private val innerUpper2 = MutableVector3f()
    private val inner13Upper1 = MutableVector3f()
    private val inner13Upper3 = MutableVector3f()
    ...
    private val outer02Mid0 = MutableVector3f()
    private val outer02Mid2 = MutableVector3f()
    private val outer13Mid1 = MutableVector3f()
    private val outer13Mid3 = MutableVector3f()
