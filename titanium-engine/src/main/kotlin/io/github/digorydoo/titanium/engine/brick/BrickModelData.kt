...
class BrickModelData(private val subvolume: BrickSubvolume, private val models: BrickModelHolder) {
    ...
    private class Part(translation: Vector3f, texWidth: Int, texHeight: Int) {
    ...
    fun rebuild(translation: Vector3f, texWidth: Int, texHeight: Int) {
        parts.clear()
    ...
    fun heightAt(relWorldX: Float, relWorldY: Float, relBrickCoords: Vector3i): Float? {
