package io.github.digorydoo.titanium.engine.physics.strategy.sphere_vs_cuboid
...
import io.github.digorydoo.titanium.engine.physics.CuboidCheckHelper.*
...
import io.github.digorydoo.titanium.engine.physics.strategy.CollisionCheckStrategy
...
internal class CheckSphereVsCuboid: CollisionCheckStrategy<FixedSphereBody, FixedCuboidBody>() {
    ...
    override fun check(
        ...
        fun check(normal: Vector3f, result: CuboidCheckResults) {
        ...
        val bestMatchPt = MutableVector3f()
