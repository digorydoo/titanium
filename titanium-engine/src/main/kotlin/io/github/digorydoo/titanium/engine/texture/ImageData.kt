...
import io.github.digorydoo.titanium.engine.font.FontManager
import io.github.digorydoo.titanium.engine.texture.texel_manip.Blitter
import io.github.digorydoo.titanium.engine.texture.texel_manip.LineArtist
import io.github.digorydoo.titanium.engine.texture.texel_manip.OvalArtist
import io.github.digorydoo.titanium.engine.texture.texel_manip.RectArtist
import io.github.digorydoo.titanium.engine.texture.texel_manip.RoundRectArtist
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgb8.BlitterRGB8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgb8.RectArtistRGB8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgba8.BlitterRGBA8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgba8.LineArtistRGBA8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgba8.OvalArtistRGBA8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgba8.RectArtistRGBA8
import io.github.digorydoo.titanium.engine.texture.texel_manip.rgba8.RoundRectArtistRGBA8
...
class ImageData(val buf: ByteBuffer, val type: Type, val width: Int, val height: Int) {
    ...
    @Suppress("unused")
    fun drawLine(a: Vector2f, b: Vector2f, c: Colour) {
