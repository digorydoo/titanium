...
class BrickSubvolume(private val volume: BrickVolume, models: BrickModelHolder, private val box: Boxi, tex: Texture) {
    ...
    private val worldOrigin = Vector3f(
    ...
    fun getBrick(subRelativeCoords: Vector3i, brick: Brick, acrossBounds: Boolean = false) {
    ...
    fun getShape(subRelativeCoords: Vector3i, acrossBounds: Boolean = false) =
    ...
    fun heightAt(worldX: Float, worldY: Float, relBrickCoords: Vector3i): Float? {
