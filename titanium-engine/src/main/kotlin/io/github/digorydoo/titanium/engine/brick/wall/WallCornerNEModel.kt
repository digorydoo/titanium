package io.github.digorydoo.titanium.engine.brick.wall
...
class WallCornerNEModel(private val relInset: Float, private val ceiling: Boolean): AbstrBrickModel() {
    private val upperNWPt = MutableVector3f()
    private val upperSEPt = MutableVector3f()
    private val ceilSouthMidPt = MutableVector3f()
    private val ceilWestMidPt = MutableVector3f()
    private val ceilEastOuterPt = MutableVector3f()
    private val ceilCentrePt = MutableVector3f()
    private val ceilSWOuterPt = MutableVector3f()
    private val lowerSouthMidPt = MutableVector3f()
    private val lowerWestMidPt = MutableVector3f()
    private val lowerEastOuterPt = MutableVector3f()
    private val lowerCentrePt = MutableVector3f()
