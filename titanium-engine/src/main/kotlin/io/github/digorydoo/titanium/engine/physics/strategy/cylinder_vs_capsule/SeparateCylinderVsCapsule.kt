package io.github.digorydoo.titanium.engine.physics.strategy.cylinder_vs_capsule
...
import io.github.digorydoo.titanium.engine.physics.UnexpectedHitArea
...
import io.github.digorydoo.titanium.engine.physics.strategy.CollisionSeparateStrategy
import io.github.digorydoo.titanium.engine.utils.TINY_GAP
...
internal class SeparateCylinderVsCapsule: CollisionSeparateStrategy<FixedCylinderBody, FixedCapsuleBody>() {
    override fun separate(body1: FixedCylinderBody, body2: FixedCapsuleBody, hit: HitResult) {
        when (hit.area2) {
            ...
            else -> throw UnexpectedHitArea(hit.area2)
        }
    }
