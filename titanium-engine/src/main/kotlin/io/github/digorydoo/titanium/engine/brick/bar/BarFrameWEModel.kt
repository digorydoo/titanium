package io.github.digorydoo.titanium.engine.brick.bar
...
class BarFrameWEModel(
    ...
    private val innerPt0 = MutableVector3f()
    private val innerPt1 = MutableVector3f()
    private val innerPt2 = MutableVector3f()
    private val innerPt3 = MutableVector3f()
    private val upperInnerPt0 = MutableVector3f()
    private val upperInnerPt1 = MutableVector3f()
    private val upperInnerPt2 = MutableVector3f()
    private val upperInnerPt3 = MutableVector3f()
    private val lowerPtN0 = MutableVector3f()
    private val lowerPtN1 = MutableVector3f()
    private val lowerPtN2 = MutableVector3f()
    private val lowerPtN3 = MutableVector3f()
    private val lowerPtS0 = MutableVector3f()
    private val lowerPtS1 = MutableVector3f()
    private val lowerPtS2 = MutableVector3f()
    private val lowerPtS3 = MutableVector3f()
