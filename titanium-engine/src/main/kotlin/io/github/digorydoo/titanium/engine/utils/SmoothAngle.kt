...
class SmoothAngle(
    initVal: Float = 0.0f,
    var accel: Float = 0.4f,
    var nearTargetThreshold: Float = 0.027f,
    var stopThreshold: Float = 0.0008f,
    var normalBrake: Float = 0.10f, // 1=stop immediately, 0=don't brake
    var strongBrake: Float = 0.15f,
) {
