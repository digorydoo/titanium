...
import io.github.digorydoo.titanium.engine.file.BrickVolumeFileWriter
import io.github.digorydoo.titanium.engine.file.HeightMapFileWriter
...
internal class EditGeneralActions(
    ...
    fun movePlayerToCursorPos() {
        ...
        val pos = brickSelection.getTipPosInWorldCoords()
