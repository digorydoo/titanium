...
enum class BrickShape(
    ...
    // 62 was STAIRS_RUN_NORTH
    // 63 was STAIRS_RUN_EAST
    // 64 was STAIRS_RUN_SOUTH
    // 65 was STAIRS_RUN_WEST
    ...
    THICK_STAIRS_11_NORTH(id = 127, relVolume = 0.42f),
    THICK_STAIRS_11_EAST(id = 128, relVolume = 0.42f),
    THICK_STAIRS_11_SOUTH(id = 129, relVolume = 0.42f),
    THICK_STAIRS_11_WEST(id = 130, relVolume = 0.42f),
    ...
    HALFH_CEILING_V_CUT_NE(id = 175, relVolume = 0.3f),
    HALFH_CEILING_V_CUT_NW(id = 176, relVolume = 0.3f),
    HALFH_CEILING_V_CUT_SE(id = 177, relVolume = 0.3f),
    HALFH_CEILING_V_CUT_SW(id = 178, relVolume = 0.3f),
    HALFH_FLOOR_V_CUT_NE(id = 179, relVolume = 0.3f),
    HALFH_FLOOR_V_CUT_NW(id = 180, relVolume = 0.3f),
    HALFH_FLOOR_V_CUT_SE(id = 181, relVolume = 0.3f),
    HALFH_FLOOR_V_CUT_SW(id = 182, relVolume = 0.3f),
    ...
    THICK_STAIRS_32_LOWER_NORTH(id = 207, relVolume = 0.42f),
    THICK_STAIRS_32_LOWER_EAST(id = 208, relVolume = 0.42f),
    THICK_STAIRS_32_LOWER_SOUTH(id = 209, relVolume = 0.42f),
    THICK_STAIRS_32_LOWER_WEST(id = 210, relVolume = 0.42f),
    THICK_STAIRS_32_UPPER_NORTH(id = 211, relVolume = 0.42f),
    THICK_STAIRS_32_UPPER_EAST(id = 212, relVolume = 0.42f),
    THICK_STAIRS_32_UPPER_SOUTH(id = 213, relVolume = 0.42f),
    THICK_STAIRS_32_UPPER_WEST(id = 214, relVolume = 0.42f),
    ;
