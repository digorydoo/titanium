...
import io.github.digorydoo.titanium.engine.behaviours.Rotate
import io.github.digorydoo.titanium.engine.behaviours.Shake
...
class TextGel(text: String, alignment: Align.Alignment? = null): GraphicElement() {
    ...
    private val frameSize = MutableVector2f(texture.width, texture.height)
