...
import io.github.digorydoo.titanium.engine.core.Assets
import java.io.File
...
class AssetsImpl: Assets() {
    ...
    companion object {
        ...
        private const val FULLY_QUALIFIED_NAME = "io.github.digorydoo.$PROJECT_NAME"
        ...
        private fun determineDistRootDir(): DistRoot? {
            ...
            when {
                protocol.equals("file", ignoreCase = true) -> {
                    ...
                    head = ""
                    tail = "/classes/kotlin/main/io/github/digorydoo/$PROJECT_NAME/main/core/AssetsImpl.class"
                ...
                protocol.equals("jar", ignoreCase = true) -> {
                    ...
                    head = "file:"
                    tail = "/main.jar!/io/github/digorydoo/$PROJECT_NAME/main/core/AssetsImpl.class"
            ...
            if (BuildConfig.isWindows) {
                // The path we got from the URL is standardized, but we need a Windows file path.
