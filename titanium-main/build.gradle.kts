...
application {
    mainClass.set("io.github.digorydoo.titanium.main.core.MainKt")
...
dependencies {
    ...
    implementation(project(":titanium-game"))
...
tasks.named("run") {
    dependsOn(":titanium-engine:test")
    dependsOn(":titanium-game:test")
