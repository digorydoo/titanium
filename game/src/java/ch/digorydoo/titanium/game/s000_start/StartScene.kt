...
class StartScene: Scene(
    ...
    override fun enter(restore: RestoredState?) {
        ...
        PickupGel(Kind.VASE, 22.0f, 5.0f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }
        PickupGel(Kind.VASE, 24.0f, 5.0f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }
        PickupGel(Kind.VASE, 26.0f, 5.0f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }
        PickupGel(Kind.VASE, 23.0f, 6.5f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }
        PickupGel(Kind.VASE, 25.0f, 6.5f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }
        PickupGel(Kind.VASE, 24.0f, 8.0f, 2.0f).also { App.content.add(it, LayerKind.MAIN_COLLIDABLE) }

        PickupGel(Kind.VASE, 25.0f, 10.0f, 2.0f).also {
