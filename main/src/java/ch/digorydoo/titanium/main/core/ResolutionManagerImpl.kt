...
import ch.digorydoo.titanium.engine.core.MILLIMETRES_PER_INCH
...
class ResolutionManagerImpl: ResolutionManager() {
    ...
    override val screenSizeDp: Point2i get() = _screenSizeDp
    private val _screenSizeDp = MutablePoint2i()

    override val dpToGlFactor: Point2f get() = _dpToGlFactor
